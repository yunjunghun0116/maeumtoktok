...
class MemberInformationScreen extends ConsumerStatefulWidget {
  const MemberInformationScreen({super.key});

  @override
  ConsumerState<MemberInformationScreen> createState() => _MemberInformationScreenState();
}

class _MemberInformationScreenState extends ConsumerState<MemberInformationScreen> {
