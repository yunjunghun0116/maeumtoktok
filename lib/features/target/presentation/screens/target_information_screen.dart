...
class TargetInformationScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TargetInformationScreen> createState() => _TargetInformationScreenState();
}

class _TargetInformationScreenState extends ConsumerState<TargetInformationScreen> {
          ...
          child: Scaffold(
            ...
            body: Column(
              ...
              children: [
                ...
                SizedBox(height: 20),
                updateContainer(title: "이름", hintText: "이름", controller: _nameController, onTap: () => _updateName()),
                SizedBox(height: 20),
                updateContainer(
                  title: "관계",
                  ...
                  children: [
                    ...
                    Expanded(
                      child: simpleActionButton(
                        "입력하기",
                        () =>
                            Navigator.push(context, MaterialPageRoute(builder: (context) => TargetPersonalityScreen())),
                      ),
                    ),
                  ],
                ),
